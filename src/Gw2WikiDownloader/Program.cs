...
internal class Downloader
{
    ...
    public Downloader()
    {
        ...
        {
            throw new FileNotFoundException("cookies.txt is missing next to the executable. The wiki's rendered pages need a logged-in session: put one cookie per line as 'name,value'.", "cookies.txt");
        }
